#!/usr/bin/env python3
"""
Rename fGARCH to NF_TGARCH in the dashboard data.
"""
...
def rename_fgarch_to_nf_tgarch():
    """Rename fGARCH to NF_TGARCH in the data."""
    print("=== RENAMING fGARCH TO NF_TGARCH ===")
    ...
    # Rename fGARCH to NF_TGARCH
    df['Model'] = df['Model'].replace('fGARCH', 'NF_TGARCH')
    
    print(f"After renaming: {len(df)} records, {len(df['Model'].unique())} unique models")
    
    # Show the updated model breakdown
    print("\n=== UPDATED MODEL BREAKDOWN ===")
    print("Standard GARCH models:")
    std_models = df[df['Model_Type'] == 'Standard GARCH']
    ...
    print(f"\nTotal models: {len(df['Model'].unique())}")
    
    # Save the renamed data
    df.to_csv('outputs/standardized/renamed_model_performance.csv', index=False)
    
    print(f"\n=== RENAMING COMPLETE ===")
    print("✅ fGARCH renamed to NF_TGARCH")
    print("✅ Standard GARCH: 4 models (sGARCH, eGARCH, gjrGARCH, TGARCH)")
    print("✅ NF-GARCH: 4 models (NF_sGARCH, NF_eGARCH, NF_gjrGARCH, NF_TGARCH)")
    print("✅ Total: 8 models")
    
    return df

def create_renamed_dashboard(df):
    """Create dashboard with renamed fGARCH to NF_TGARCH."""
    print("\n=== CREATING RENAMED DASHBOARD ===")
    ...
    print(f"Renamed dashboard created: {html_path}")
    return html_path
...
<head>
    ...
    <title>NF-GARCH Research Dashboard - fGARCH Renamed to NF_TGARCH</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>fGARCH Renamed to NF_TGARCH - Complete Analysis</p>
            ...
            <div id="overview" class="tab-content active">
                <div class="section">
                    ...
                    <div class="success-box">
                        <h3>✅ fGARCH Renamed to NF_TGARCH</h3>
                        <p><strong>Corrected Model Classification:</strong></p>
                        <ul>
                            <li><strong>Standard GARCH (4 models):</strong> sGARCH, eGARCH, gjrGARCH, TGARCH</li>
                            <li><strong>NF-GARCH (4 models):</strong> NF_sGARCH, NF_eGARCH, NF_gjrGARCH, NF_TGARCH</li>
                            <li><strong>Total:</strong> 8 models</li>
                        </ul>
                        <p><strong>Key Fix:</strong> fGARCH renamed to NF_TGARCH (Normalizing Flow Threshold GARCH)</p>
                    </div>
                </div>
            </div>
...
def main():
    ...
    # Rename fGARCH to NF_TGARCH
    df = rename_fgarch_to_nf_tgarch()
    
    # Create renamed dashboard
    create_renamed_dashboard(df)
